...
import name.vbraun.filepicker.DirListFragment.OnChangeLocationListener;
import name.vbraun.filepicker.EventHandler.OnWorkerThreadFinishedListener;
import name.vbraun.filepicker.DialogHandler.OnSearchFileSelected; 
...
public class DirContentFragment extends Fragment implements OnItemClickListener,
	...
	private static boolean mMultiSelectOn = true;
	...
	protected void changeActionBarTitle(String title) {
		((FilePickerActivityOld)getActivity()).changeActionBarTitle(title);			
	}
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
			...
			case D_MENU_DELETE:
				...
				case D_MENU_COPY:
					...
					mHoldingFile = true;
					mCutFile = false;
					changeActionBarTitle("Holding " + name);
					mode.finish();
					return true;
				...
				case D_MENU_PASTE:
					...
					changeActionBarTitle("Open Manager");
					mode.finish();
					return true;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mHoldingFile = false;
		mActionModeSelected = false;
		DirListFragment.setOnChangeLocationListener(this);
	}
